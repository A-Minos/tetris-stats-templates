import{y as se,h,l as le,c as I,b as c,m as de,d as x,a as te,e as ce,u as Ee,g as He,i as r,p as O,f as Ne}from"./light-C_Y72ozn.js";import{i as D}from"./is-browser-DqcmxZSF.js";import{u as Oe}from"./_common-5_w4YOod.js";import{l as ue,L as je,k,C as fe,d as M,h as l,T as De,R as be,q as _,E as Me}from"./index-B32syGsN.js";import{c as Ke}from"./dark-DNz4JDPS.js";import{c as ne}from"./color-to-class-B0iQgAn2.js";import{u as he,r as ie,i as Ve}from"./use-style-zT4CEviH.js";import{N as We}from"./FadeInExpandTransition-FrHreAUX.js";import{i as Ge}from"./use-is-mounted-Ca8xuiZg.js";import{c as qe}from"./call-f2ri57Kd.js";const ae=se("n-form-item");function Le(e,{defaultSize:a="medium",mergedSize:s,mergedDisabled:d}={}){const n=ue(ae,null);je(ae,null);const v=k(s?()=>s(n):()=>{const{size:g}=e;if(g)return g;if(n){const{mergedSize:F}=n;if(F.value!==void 0)return F.value}return a}),P=k(d?()=>d(n):()=>{const{disabled:g}=e;return g!==void 0?g:n?n.disabled.value:!1}),R=k(()=>{const{status:g}=e;return g||(n==null?void 0:n.mergedValidationStatus.value)});return fe(()=>{n&&n.restoreValidation()}),{mergedSizeRef:v,mergedDisabledRef:P,mergedStatusRef:R,nTriggerFormBlur(){n&&n.handleContentBlur()},nTriggerFormChange(){n&&n.handleContentChange()},nTriggerFormFocus(){n&&n.handleContentFocus()},nTriggerFormInput(){n&&n.handleContentInput()}}}const ve=M({name:"BaseIconSwitchTransition",setup(e,{slots:a}){const s=Ge();return()=>l(De,{name:"icon-switch-transition",appear:s.value},a)}}),{cubicBezierEaseInOut:Qe}=le;function U({originalTransform:e="",left:a=0,top:s=0,transition:d=`all .3s ${Qe} !important`}={}){return[h("&.icon-switch-transition-enter-from, &.icon-switch-transition-leave-to",{transform:e+" scale(0.75)",left:a,top:s,opacity:0}),h("&.icon-switch-transition-enter-to, &.icon-switch-transition-leave-from",{transform:`scale(1) ${e}`,left:a,top:s,opacity:1}),h("&.icon-switch-transition-enter-active, &.icon-switch-transition-leave-active",{transformOrigin:"center",position:"absolute",left:a,top:s,transition:d})]}const Ye=h([h("@keyframes rotator",`
 0% {
