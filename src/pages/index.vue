...
const test_binding = () => {
	document.querySelector<HTMLTemplateElement>('template#data')!.innerHTML = JSON.stringify(new class {
		...
		readonly user = new class {
			readonly name = prompt('用户名', 'creeperqwq')
